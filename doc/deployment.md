...
1. Deploy [AGLDTokenV1](../contracts/AGLDTokenV1.sol)
...
1. Obtain addresses for the various contract roles from AnthemGold ops. The keys for these addresses will be stored offline.
...
2. Deploy [AGLDTokenProxy](../contracts/AGLDTokenProxy.sol), passing the address of the deployed implementation contract
...
These addresses should be obtained from AnthemGold ops, and the keys will be stored offline.
